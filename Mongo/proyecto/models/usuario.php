<?php
require 'vendor/autoload.php'; // Asegúrate de tener MongoDB habilitado en tu proyecto
use MongoDB\Client;
class Usuario {
    private $id;
    private $nombre;
    ...
    public function guardarMongoDB() {
        // Conectar a MongoDB
        $client = new Client("mongodb://localhost:27017");
        $collection = $client->MiTiendaDB->usuarios;  // Asume que la base de datos es MiTiendaDB y la colección es 'usuarios'

        // Encriptar la contraseña antes de guardarla
        $clave_hash = password_hash($this->getClave(), PASSWORD_BCRYPT);
        ...
        try {
            ...
            return $resultado->getInsertedCount() > 0;  // Si la inserción es exitosa, devuelve true
        } catch (Exception $e) {
